			...
			<section>
				<div className="w-11/12 mx-auto px-5 py-4 my-2 rounded-lg bg-white/90 flex flex-col md:flex-row md:pr-2 md:py-24 md:mx-auto shadow-2xl">
					<div className="md:w-2/5 w-full md:flex items-center md:flex-col text-center pr-5">
						<h1 className="text-center text-3xl lg:text-5xl sm:text-4xl font-Principal title-font mb-4">
							Contact Us
						</h1>
					...
					<div className="md:w-3/5 w-full md:pl-20">
						<h1 className="text-center font-Principal text-2xl lg:text-5xl text-gray-800 sm:text-4xl mb-2 mt-2">
							Contact Form
						</h1>
						<form onSubmit={handleSubmit(getForm)}>
							<div className="p-2 w-full">
								<div className="relative">
									<label
										htmlFor="name"
										className="font-Principal leading-7 py-4 text-lg md:text-xl text-gray-900"
									>
										Your Name
									</label>
									<input
							...
							<div className="p-2 w-full">
								<div className="relative">
									<label
										htmlFor="email"
										className="font-Principal text:lg md:text-xl leading-7 py-4 text-gray-900"
									>
										Your Email
									</label>
									<input
							...
							<div className="p-2 w-full">
								<div className="relative">
									<label
										htmlFor="message"
										className="text-base font-Principal leading-7 py-4 md:text-xl text-gray-900"
									>
										Type your message
									</label>
									<textarea
										id="message"
										className="w-full font-Secundaria bg-white rounded border border-gray-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-900 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out "
										{...register("message", {
											required: true,
											minLength: 20,
											maxLength: 500,
									...
									{errors.message?.type === "minLength" && (
										<p className="text-red-600">
											Your message should have 20 letters at least
										</p>
									)}
									{errors.message?.type === "maxLength" && (
										<p className="text-red-600">
											Your nickname can't be longer that 500 letters
										</p>
									)}
								</div>
							</div>
							<div className="p-2 w-full">
								<button
									type="submit"
									className="font-Principal text-white bg-Pink2 border-0 py-2 px-4 focus:outline-none hover:bg-Pink1 rounded text-xl md:text-2xl shadow-lg mx-0 flex-col text-center"
								>
									Send Message ✉
								</button>
							</div>
