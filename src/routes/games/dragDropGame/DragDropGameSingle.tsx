...
const DragDropGameSingle: React.FC = () => {
	...
	const sorted1 = copyOfItemsDnDGame.sort(
		() => randomIndex(ItemsDnDGame) - randomIndex(ItemsDnDGame),
	)
	const sorted2 = copyOfItemsDnDGame2.sort(
		() => randomIndex(ItemsDnDGame) - randomIndex(ItemsDnDGame),
	)
	...
	return (
		<main className="w-screen h-screen bg-green-400 overflow-x-hidden">
			<NavBar />
			<h1 className="font-Principal tracking-wide text-center text-2xl text-white text-3d lg:text-4xl">
				Drag and Drop
			</h1>
