      ...
      <main className="w-screen h-screen bg-Gradient1 overflow-x-hidden">
        ...
        <section className="bg-white/90 p-6 lg:p-8 w-[90dvw] mx-auto rounded-md my-3" >
          ...
          <p className="font-Secundaria pt-2">
            ...
            We have adopted this Privacy Policy, which determines how we process information collected by BEESMRT, which also provides the reasons why we must collect certain personal data about you. Therefore, you should read this Privacy Policy before using the BEESMRT website.
          ...
          <div className="font-Secundaria">
            When you visit BEESMRT, we automatically collect certain information about your device:
          ...
          <div className="font-Secundaria">
            ...
            <p className="pb-2"> Additionally, as you browse the site, we collect information about: </p>
            <ul className="list-disc ml-4 mb-4">
              <li className="mb-2">The individual web pages or products you view</li>
              <li className="mb-2">What websites or search terms referred you to the site and how you interact with it</li>
            </ul>
            <p className="mb-4">
              We refer to this automatically collected information as "Device Information." Additionally, we may collect the personal data you provide to us during registration in order to fulfill the agreement
            </p>
            <ul className="list-disc ml-4">
          ...
          <h2 className="py-2 text-2xl font-Principal">
            Your rights:
          </h2>
          ...
          <ul className="list-disc ml-4 mb-4 font-Secundaria">
            ...
            <li className="mb-2">Rights in relation to automated decision making and profiling</li>
          </ul>
          ...
          <ul className="list-disc ml-4 font-Secundaria">
            ...
            <li className="py-2">
              ...
              <p>If you wish to contact us to understand more about this Policy or wish to contact us regarding any matter regarding individual rights and your personal information, you may email us at angeljonasrosales@gmail.com</p>
            </li>
          </ul>
        </section>
      </main>
