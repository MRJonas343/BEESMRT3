...
const SpinningCoin: React.FC<SpinningCoinProps> = ({ showModalCoin, headsOrTails, changeCoin, activePlayer }) => {
  ...
  return (
    <div className={modalContainer}>
      <div className="bg-white w-[350px] h-3/6 rounded-xl p-7 absolute z-30 top-1/2 left-1/2 fixPosition lg:w-1/3">
        <div className='flex flex-col items-center mt-5'>
          ...
          <div onClick={changeCoin} className={coinContainer}>
            <div className={faceClassName}>
              <img src={cara} className='absolute w-full h-full object-cover' />
            </div>
            <div className={backClassName}>
              <img src={cruz} className='w-full h-full object-cover' />
            </div>
          </div>
