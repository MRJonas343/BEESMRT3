...
const NavBar: React.FC = () => {
	...
	const btnClassName = isExpanded
		...
		: " w-5 h-5 bg-cover bg-center cursor-pointer transition-all z-50 md:hidden bg-open-menu"
	...
	return (
		<nav className="w-[95%] px-6 mx-auto overflow-hidden h-9 mt-3 flex items-center justify-between font-Principal text-3xl text-3d text-white xl:w-screen xl:px-12">
			...
			<Link
				to="/MyAccount"
				className="hidden lg:block hover:scale-110 ease-in-out duration-200 hover:text-purple-500"
			>
