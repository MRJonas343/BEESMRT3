...
const HomeCard: React.FC<HomeCardProps> = ({ imageSrc, title, text }) => {
  return (
    <div className="bg-white/70 w-[43dvw] flex flex-col items-center overflow-hidden p-5 rounded-2xl ease-in-out duration-200 hover:scale-105 hover:bg-yellow-400 cursor-pointer md:h-[37dvh] lg:w-[22dvw] lg:h-[55dvh] pt-16">
