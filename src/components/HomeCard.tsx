...
const HomeCard: React.FC<HomeCardProps> = ({ imageSrc, title, text }) => {
	return (
		<div className="bg-white/70 w-[43vw] h-[40vh] flex flex-col items-center overflow-auto p-5 rounded-2xl ease-in-out duration-200 hover:scale-105 hover:bg-yellow-400 cursor-pointer md:h-[37vh] lg:w-[22vw] lg:h-[55vh] lg:pt-20 shadow-2xl">
